		...
		req.getParts().stream()
					  ...
					  .forEach(part -> {
						  ...
						  try {
							  ...
							  // 圖片名字
							  String imageName = part.getSubmittedFileName(); // 取得 client 上傳的檔名
